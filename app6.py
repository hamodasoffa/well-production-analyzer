...
if uploaded_file:
    try:
        ...
        if len(selected_parameters) == 0:
            ...
            # PDF report export using ReportLab. This does NOT need Chrome or Kaleido.
            try:
                ...
                story.append(Paragraph(
                    "Note: The interactive chart is available from the HTML download button. "
                    "This PDF report contains well information, summary statistics, and events without requiring Chrome.",
                    styles["Italic"]
                ))
